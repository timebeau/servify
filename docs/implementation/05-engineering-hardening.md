...
- [ ] 设计 server 版本号注入
- [ ] 设计 SDK workspace version strategy
- [ ] 预留 changelog 生成脚本
- [ ] 预留 tag/release action
...
- [ ] 盘点当前 integration build tag 覆盖面
- [ ] 为 `voice` 补 handler 到 runtime 的端到端测试
- [ ] 为 `ai` 补 provider fallback 集成测试
- [ ] 为 `sdk` 补 examples smoke tests
- [ ] 为关键模块定义最小冒烟用例集合
...
- [ ] 补 VuePress 站点配置骨架
- [ ] 补 docs 导航与侧边栏生成策略
- [ ] 增加 GitHub Pages 或 artifact 发布流程
- [ ] 增加 Mermaid 渲染兼容性约束说明
